...
<p align="center">
  <strong>感謝 <a href="https://www.jetbrains.com/?from=fast-api">JetBrains</a> 為本項目提供免費的開源開發許可證</strong>
</p>
...
### 📖 [官方文件](https://docs.newapi.pro/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/fast-api)
...
- 📱 Telegram 授權登錄
- 🔑 OIDC 統一認證
- 🔍 Key 查詢使用額度（配合 [fast-api-key-tool](https://github.com/Calcium-Ion/fast-api-key-tool)）
...
> [!TIP]
> **最新版 Docker 鏡像：** `calciumion/fast-api:latest`
...
| `PYROSCOPE_APP_NAME` | Pyroscope 應用名                                        | `fast-api` |
...
| `HOSTNAME` | Pyroscope 標籤裡的主機名                                          | `fast-api` |
...
| 項目 | 說明 |
|------|------|
| [fast-api-key-tool](https://github.com/Calcium-Ion/fast-api-key-tool) | Key 額度查詢工具 |
| [fast-api-horizon](https://github.com/Calcium-Ion/fast-api-horizon) | Fast API 高性能優化版 |
...
**[官方文件](https://docs.newapi.pro/zh/docs)** • **[問題回饋](https://github.com/Calcium-Ion/fast-api/issues)** • **[最新發布](https://github.com/Calcium-Ion/fast-api/releases)**
