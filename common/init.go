...
func printHelp() {
	fmt.Println("FastAPI(Based OneAPI) " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Original Project: OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Maintainer: QuantumNous - https://github.com/QuantumNous/fast-api")
	fmt.Println("Usage: fastapi [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
