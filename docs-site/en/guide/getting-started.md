...
Open [Fast API](https://www.fastapi.cool), create an account, and complete email verification.

## 2. Create an API key

Open the [API Keys](https://www.fastapi.cool/keys) page in the console:
...
Open the [model catalog](https://www.fastapi.cool/pricing) to review currently available models and pricing, then copy the model name.
