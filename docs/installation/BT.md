...
本文档提供使用宝塔面板 Docker 功能部署 Fast API 的图文教程。
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/fast-api`
...
services:
  fast-api:
    image: calciumion/fast-api:latest
...
- [GitHub 仓库](https://github.com/QuantumNous/fast-api)
