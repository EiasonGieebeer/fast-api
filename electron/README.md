# Fast API Electron Desktop App

This directory contains the Electron wrapper for Fast API, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., fast-api-macos)
cp ../fast-api-macos ../fast-api
```
...
- Store database in `../data/fast-api.db`
...
### Database Location
- **Development**: `../data/fast-api.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/Fast API/data/`
  - Windows: `%APPDATA%/Fast API/data/`
  - Linux: `~/.config/Fast API/data/`
