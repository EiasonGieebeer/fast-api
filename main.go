...
import (
	...
	"github.com/QuantumNous/fast-api/controller"
	...
	"github.com/QuantumNous/fast-api/oauth"
	perfmetrics "github.com/QuantumNous/fast-api/pkg/perf_metrics"
	"github.com/QuantumNous/fast-api/relay"
	"github.com/QuantumNous/fast-api/router"
	"github.com/QuantumNous/fast-api/service"
	_ "github.com/QuantumNous/fast-api/setting/performance_setting"
...
func main() {
	...
	common.SysLog("Fast API " + common.Version + " started")
	...
	server.Use(gin.CustomRecovery(func(c *gin.Context, err any) {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": gin.H{
				"message": fmt.Sprintf("Panic detected, error: %v. Please submit a issue here: https://github.com/Calcium-Ion/fast-api", err),
				"type":    "new_api_panic",
			},
		})
	}))
