...
import (
	...
	"github.com/QuantumNous/fast-api/relay/common"
...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *common.RelayInfo) (usage any, err *types.FastAPIError) {
	if info.IsStream {
