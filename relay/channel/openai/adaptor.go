...
import (
	...
	"github.com/QuantumNous/fast-api/relay/channel/ai360"
	"github.com/QuantumNous/fast-api/relay/channel/lingyiwanwu"

	//"github.com/QuantumNous/fast-api/relay/channel/minimax"
	"github.com/QuantumNous/fast-api/relay/channel/openrouter"
	"github.com/QuantumNous/fast-api/relay/channel/xinference"
	relaycommon "github.com/QuantumNous/fast-api/relay/common"
	"github.com/QuantumNous/fast-api/relay/common_handler"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		...
		if header.Get("X-OpenRouter-Title") == "" {
			header.Set("X-OpenRouter-Title", "Fast API")
		}
	}
	return nil
}
...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (usage any, err *types.FastAPIError) {
	switch info.RelayMode {
