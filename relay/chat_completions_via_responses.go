...
import (
	...
	openaichannel "github.com/QuantumNous/fast-api/relay/channel/openai"
...
func chatCompletionsViaResponses(c *gin.Context, info *relaycommon.RelayInfo, adaptor channel.Adaptor, request *dto.GeneralOpenAIRequest) (*dto.Usage, *types.FastAPIError) {
