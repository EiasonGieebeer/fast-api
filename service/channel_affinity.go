...
import (
	...
	"github.com/QuantumNous/fast-api/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "fast-api:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "fast-api:channel_affinity_usage_cache_stats:v1"
)
