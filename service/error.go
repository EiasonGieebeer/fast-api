...
func RelayErrorHandler(ctx context.Context, resp *http.Response, showBodyWhenFail bool) (newApiErr *types.FastAPIError) {
...
func ResetStatusCode(newApiErr *types.FastAPIError, statusCodeMappingStr string) {
	if newApiErr == nil {
		return
	}
...
// TaskErrorFromAPIError 将 PreConsumeBilling 返回的 FastAPIError 转换为 TaskError。
func TaskErrorFromAPIError(apiErr *types.FastAPIError) *taskdto.TaskError {
	if apiErr == nil {
		return nil
	}
