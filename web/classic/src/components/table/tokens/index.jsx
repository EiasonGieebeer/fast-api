...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-fast-api-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-fast-api-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-fast-api-container') return true;
      return (
