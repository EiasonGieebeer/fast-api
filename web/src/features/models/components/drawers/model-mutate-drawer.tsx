          ...
          >
            ...
            <SideDrawerSection>
              ...
              <p className='text-muted-foreground text-xs'>
                {t(
                  'Optional specs shown on the model details page. Leave empty to use automatic inference.'
                )}
              </p>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder='16K' {...field} />
                    </FormControl>
                    <FormDescription>
                      {t(
                        'Maximum tokens the model can generate (e.g. 4K, 16K)'
                      )}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder='2025-06-15' {...field} />
                      </FormControl>
                      <FormDescription className='text-xs'>
                        {t('e.g. 2025-06-15')}
                      </FormDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {t(
                        'JSON array: function_calling, streaming, vision, reasoning, tools, json_mode, structured_output, web_search, code_interpreter, caching, embeddings, system_prompt'
                      )}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                ...
                render={({ field }) => (
                  <FormItem className={sideDrawerSwitchItemClassName()}>
                    <div className='flex flex-col gap-0.5'>
                      ...
                      <FormDescription>
                        {t(
                          'Display the Capabilities / Supported modalities section on the model detail page.'
                        )}
                      </FormDescription>
                    </div>
                    <FormControl>
